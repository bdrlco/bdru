...
inline bool IsProtocolV3(int nHeight) { return TestNet() || nHeight > 103000; }
...
inline unsigned int GetTargetSpacing(int nHeight) { return IsProtocolV2(nHeight) ? 249 : 240; }
