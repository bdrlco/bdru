...
public:
    CMainParams() {
        ...
        const char* pszTimestamp = "BDR-Unit Genesis Blockchain Technology: The Beginning 5/19";
        ...
        vout.resize(1);
        vout[0].SetEmpty();
        CTransaction txNew(1, 1557526487, vin, vout, 0);
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime    = 1557526487;
        genesis.nBits    = 0x1e0fffff;
        genesis.nNonce   = 1501137;

        
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000d6bb3530b4f1f663d5da612ed8ae9545d12f63a1bb711d27a322154c74f"));
        assert(genesis.hashMerkleRoot == uint256("0x287742c60fcf47f31709d13ebd47788a20ea05cc87ad3f3b4ce08ba2f6677774"));
		...
		vSeeds.push_back(CDNSSeedData("seed3", "194.135.95.237"));
